...
const Island = ({ isRotating, setIsRotating, setCurrentStage, currentFocusPoint, ...props}) => {
    ...
    return (
        ...
        <a.group position={[20.57, -1.167, 22.781]} rotation={[-Math.PI, -0.346, -Math.PI]}>
            <mesh
        ...
        <a.group position={[30.764, -0.776, 27.677]} rotation={[-Math.PI, -0.374, -Math.PI]}>
            <mesh
        ...
        <a.group position={[0.034, 5.255, 1.433]} rotation={[0, 0.682, 0]} scale={1.101}>
            <mesh
        ...
        <a.group position={[-2.249, 9.262, -3.695]} rotation={[0, -Math.PI / 2, 0]} scale={1.118}>
            <mesh
        ...
        <a.group position={[2.733, 0.266, -28.39]} rotation={[2.699, 1.538, -2.658]}>
            <mesh
        ...
        <a.group position={[-37.76, -1.453, 11.464]} rotation={[-Math.PI, -1.023, -Math.PI]}>
            <mesh
        ...
        <a.group position={[-36.66, -1.274, 6.794]} rotation={[-Math.PI, -0.855, -Math.PI]}>
            <mesh
        ...
        <a.group position={[9.746, 0.811, 22.735]} rotation={[-0.018, 0.056, 0.024]} scale={0.643}>
            <mesh
        ...
        <a.group position={[-8.044, 0.507, 35.484]} rotation={[0, 1.309, 0]} scale={0.768}>
            <mesh
        ...
        <a.group position={[1.082, 0.032, -0.12]} rotation={[-0.001, 0.044, -0.001]}>
            <mesh
        ...
        <a.group position={[-22.414, -12.808, 9.521]} rotation={[-0.178, 0.816, 0.173]}>
            <mesh
        ...
        <a.group position={[17.384, -9.978, 31.718]} rotation={[-0.972, -1.045, -0.484]}>
            <mesh
        ...
        <a.group position={[1.764, -10.134, -4.324]} rotation={[2.991, 0.292, 3.101]}>
            <mesh
